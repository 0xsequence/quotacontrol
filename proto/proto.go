...
//go:generate go run github.com/webrpc/webrpc/cmd/webrpc-gen -schema=proto.ridl -target=golang@v0.14.8 -pkg=quotacontrol -client -out=./clients/quotacontrol.gen.go
