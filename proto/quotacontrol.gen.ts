...
//
// webrpc-gen -schema=proto.ridl -target=typescript@v0.12.0 -client -out=./quotacontrol.gen.ts
...
export const WebRPCSchemaHash = "4933cab8ab9295055c64182cac0e128f2b63bf92"
...
const webrpcErrorByCode: { [code: number]: any } = {
  ...
  [2001]: TimeoutError,
  [2002]: QuotaExceededError,
  [2003]: RateLimitError,
  [2004]: ProjectNotFoundError,
  [2005]: AccessKeyNotFoundError,
  [2006]: AccessKeyMismatchError,
  [2007]: InvalidOriginError,
  [2008]: InvalidServiceError,
  [2009]: UnauthorizedUserError,
  [2011]: NoDefaultKeyError,
  [2012]: MaxAccessKeysError,
  [2013]: AtLeastOneKeyError,
}
