...
export const WebrpcSchemaVersion = "v0-26.4.3+41fe483"

// Schema hash generated from your RIDL schema
export const WebrpcSchemaHash = "379aa5640827e2acb3d6585c1e4e22517cf9f803"
...
export interface QuotaControlClient {
   ...
   * Quota V2
   */
  getProjectInfo(req: GetProjectInfoRequest, headers?: object, signal?: AbortSignal): Promise<GetProjectInfoResponse>

  clearProjectInfoCache(req: ClearProjectInfoCacheRequest, headers?: object, signal?: AbortSignal): Promise<ClearProjectInfoCacheResponse>

  getServiceLimit(req: GetServiceLimitRequest, headers?: object, signal?: AbortSignal): Promise<GetServiceLimitResponse>

  clearServiceLimitCache(req: ClearServiceLimitCacheRequest, headers?: object, signal?: AbortSignal): Promise<ClearServiceLimitCacheResponse>

  clearAccessKeyCache(req: ClearAccessKeyCacheRequest, headers?: object, signal?: AbortSignal): Promise<ClearAccessKeyCacheResponse>
}
...
export interface ClearProjectInfoCacheRequest {
  projectID: number
}

export interface ClearProjectInfoCacheResponse {
  ok: boolean
}

export interface GetServiceLimitRequest {
  projectId: number
  service: Service
}

export interface GetServiceLimitResponse {
  limit: Limit
}

export interface ClearServiceLimitCacheRequest {
  projectID: number
  service: Service
}

export interface ClearServiceLimitCacheResponse {
  ok: boolean
}

export interface ClearAccessKeyCacheRequest {
  accessKey: string
}

export interface ClearAccessKeyCacheResponse {
  ok: boolean
}
...
export class QuotaControl implements QuotaControlClient {
  ...
  queryKey = {
    ping: () => ['QuotaControl', 'ping'] as const,
    ...
    getProjectInfo: (req: GetProjectInfoRequest) => ['QuotaControl', 'getProjectInfo', req] as const,
    clearProjectInfoCache: (req: ClearProjectInfoCacheRequest) => ['QuotaControl', 'clearProjectInfoCache', req] as const,
    getServiceLimit: (req: GetServiceLimitRequest) => ['QuotaControl', 'getServiceLimit', req] as const,
    clearServiceLimitCache: (req: ClearServiceLimitCacheRequest) => ['QuotaControl', 'clearServiceLimitCache', req] as const,
    clearAccessKeyCache: (req: ClearAccessKeyCacheRequest) => ['QuotaControl', 'clearAccessKeyCache', req] as const,
  }
  ...
  getProjectInfo = (req: GetProjectInfoRequest, headers?: object, signal?: AbortSignal): Promise<GetProjectInfoResponse> => {
    return this.fetch(
      this.url('GetProjectInfo'),
      createHttpRequest(JsonEncode(req, 'GetProjectInfoRequest'), headers, signal)).then((res) => {
      return buildResponse(res).then(_data => {
        return JsonDecode<GetProjectInfoResponse>(_data, 'GetProjectInfoResponse')
      })
    }, (error) => {
      throw WebrpcRequestFailedError.new({ cause: `fetch(): ${error instanceof Error ? error.message : String(error)}` })
    })
  ...
  clearProjectInfoCache = (req: ClearProjectInfoCacheRequest, headers?: object, signal?: AbortSignal): Promise<ClearProjectInfoCacheResponse> => {
    return this.fetch(
      this.url('ClearProjectInfoCache'),
      createHttpRequest(JsonEncode(req, 'ClearProjectInfoCacheRequest'), headers, signal)).then((res) => {
      return buildResponse(res).then(_data => {
        return JsonDecode<ClearProjectInfoCacheResponse>(_data, 'ClearProjectInfoCacheResponse')
      })
    }, (error) => {
      throw WebrpcRequestFailedError.new({ cause: `fetch(): ${error instanceof Error ? error.message : String(error)}` })
    })
  ...
  getServiceLimit = (req: GetServiceLimitRequest, headers?: object, signal?: AbortSignal): Promise<GetServiceLimitResponse> => {
    return this.fetch(
      this.url('GetServiceLimit'),
      createHttpRequest(JsonEncode(req, 'GetServiceLimitRequest'), headers, signal)).then((res) => {
      return buildResponse(res).then(_data => {
        return JsonDecode<GetServiceLimitResponse>(_data, 'GetServiceLimitResponse')
      })
    }, (error) => {
      throw WebrpcRequestFailedError.new({ cause: `fetch(): ${error instanceof Error ? error.message : String(error)}` })
    })
  ...
  clearServiceLimitCache = (req: ClearServiceLimitCacheRequest, headers?: object, signal?: AbortSignal): Promise<ClearServiceLimitCacheResponse> => {
    return this.fetch(
      this.url('ClearServiceLimitCache'),
      createHttpRequest(JsonEncode(req, 'ClearServiceLimitCacheRequest'), headers, signal)).then((res) => {
      return buildResponse(res).then(_data => {
        return JsonDecode<ClearServiceLimitCacheResponse>(_data, 'ClearServiceLimitCacheResponse')
      })
    }, (error) => {
      throw WebrpcRequestFailedError.new({ cause: `fetch(): ${error instanceof Error ? error.message : String(error)}` })
    })
  ...
  clearAccessKeyCache = (req: ClearAccessKeyCacheRequest, headers?: object, signal?: AbortSignal): Promise<ClearAccessKeyCacheResponse> => {
    return this.fetch(
      this.url('ClearAccessKeyCache'),
      createHttpRequest(JsonEncode(req, 'ClearAccessKeyCacheRequest'), headers, signal)).then((res) => {
      return buildResponse(res).then(_data => {
        return JsonDecode<ClearAccessKeyCacheResponse>(_data, 'ClearAccessKeyCacheResponse')
      })
    }, (error) => {
      throw WebrpcRequestFailedError.new({ cause: `fetch(): ${error instanceof Error ? error.message : String(error)}` })
    })
...
export class InvalidScopeError extends WebrpcError {
  constructor(error: WebrpcErrorParams = {}) {
    super(error)
    this.name = error.name || 'InvalidScope'
    this.code = typeof error.code === 'number' ? error.code : 1010
    this.message = error.message || `Scope not allowed`
    this.status = typeof error.status === 'number' ? error.status : 403
    if (error.cause !== undefined) this.cause = error.cause
...
export class InvalidOriginError extends WebrpcError {
  constructor(error: WebrpcErrorParams = {}) {
    ...
    this.message = error.message || `Invalid origin for Access Key. Check your settings at https://dashboard.trails.build or https://sequence.build`
    this.status = typeof error.status === 'number' ? error.status : 403
    if (error.cause !== undefined) this.cause = error.cause
...
export class InvalidServiceError extends WebrpcError {
  constructor(error: WebrpcErrorParams = {}) {
    ...
    this.message = error.message || `Service not enabled for Access key. Check your settings at https://dashboard.trails.build or https://sequence.build`
    this.status = typeof error.status === 'number' ? error.status : 403
    if (error.cause !== undefined) this.cause = error.cause
...
export class InvalidChainError extends WebrpcError {
  constructor(error: WebrpcErrorParams = {}) {
    ...
    this.message = error.message || `Network not enabled for Access key. Check your settings at https://dashboard.trails.build or https://sequence.build`
    this.status = typeof error.status === 'number' ? error.status : 403
    if (error.cause !== undefined) this.cause = error.cause
...
export class QuotaExceededError extends WebrpcError {
  constructor(error: WebrpcErrorParams = {}) {
    ...
    this.message = error.message || `Project quota exceeded. Upgrade your project to increase your limits: https://dashboard.trails.build or https://sequence.build`
...
export class QuotaRateLimitError extends WebrpcError {
  constructor(error: WebrpcErrorParams = {}) {
    ...
    this.message = error.message || `Project rate limit exceeded. Upgrade your project to increase your limits: https://dashboard.trails.build or https://sequence.build`
    this.status = typeof error.status === 'number' ? error.status : 429
    if (error.cause !== undefined) this.cause = error.cause
...
export const WebrpcHeaderValue = "webrpc@v0.31.1;gen-typescript@v0.22.5;quota-control@v0-26.4.3+41fe483"
