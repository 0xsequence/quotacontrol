...
export const WebRPCSchemaHash = "4301435f9093b603c16d1430c4baa4dddc9d0e29"
...
export class EnvironmentMismatchError extends WebrpcError {
  constructor(
    name: string = 'EnvironmentMismatch',
    code: number = 1106,
    message: string = 'Environment mismatch',
    status: number = 0,
    cause?: string
  ) {
    super(name, code, message, status, cause)
...
export class PrefixMismatchError extends WebrpcError {
  constructor(
    name: string = 'PrefixMismatch',
    code: number = 1107,
    message: string = 'Prefix mismatch',
    status: number = 0,
    cause?: string
  ) {
    super(name, code, message, status, cause)
    Object.setPrototypeOf(this, PrefixMismatchError.prototype)
  }
}
...
export const webrpcErrorByCode: { [code: number]: any } = {
  ...
  [1106]: EnvironmentMismatchError,
  [1107]: PrefixMismatchError,
