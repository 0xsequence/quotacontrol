...
export const WebRPCSchemaHash = "55381e43b3fa15adb2a72acfd45bb796bc05e9d6"
...
export interface QuotaControl {
  ...
  getUsageProject(args: GetUsageProjectArgs, headers?: object, signal?: AbortSignal): Promise<GetUsageProjectReturn>
  getUsageAccessKey(args: GetUsageAccessKeyArgs, headers?: object, signal?: AbortSignal): Promise<GetUsageAccessKeyReturn>
  getUsageAsync(args: GetUsageAsyncArgs, headers?: object, signal?: AbortSignal): Promise<GetUsageAsyncReturn>
  ...
  storeUsageProject(args: StoreUsageProjectArgs, headers?: object, signal?: AbortSignal): Promise<StoreUsageProjectReturn>
  storeUsageAccessKey(args: StoreUsageAccessKeyArgs, headers?: object, signal?: AbortSignal): Promise<StoreUsageAccessKeyReturn>
...
export interface GetUsageProjectArgs {
  projectID: number
  service?: Service
  from?: string
  to?: string
...
export interface GetUsageProjectReturn {
  usage: number  
}
export interface GetUsageAccessKeyArgs {
  accessKey: string
  service?: Service
  from?: string
  to?: string
...
export interface GetUsageAccessKeyReturn {
  usage: number  
}
export interface GetUsageAsyncArgs {
  projectID: number
  service?: Service
  from?: string
  to?: string
...
export interface GetUsageAsyncReturn {
  usage: number  
}
...
export interface StoreUsageProjectArgs {
  service: Service
  now: string
  usage: {[key: number]: number}
}

export interface StoreUsageProjectReturn {
  ok: {[key: number]: boolean}  
}
export interface StoreUsageAccessKeyArgs {
  service: Service
  now: string
  usage: {[key: string]: number}
}

export interface StoreUsageAccessKeyReturn {
  ok: {[key: string]: boolean}  
}
