// quota-control v0.1.0 9dc3f81948a280ef53ee2b75412878a16a82d1a2
// --
...
func WebRPCSchemaHash() string {
	return "9dc3f81948a280ef53ee2b75412878a16a82d1a2"
}
...
type QuotaControl interface {
	...
	GetUsage(ctx context.Context, projectID uint64, service *Service, now time.Time) (*AccessUsage, error)
...
func (c *quotaControlClient) GetUsage(ctx context.Context, projectID uint64, service *Service, now time.Time) (*AccessUsage, error) {
	in := struct {
		Arg0 uint64    `json:"projectID"`
		Arg1 *Service  `json:"service"`
		Arg2 time.Time `json:"now"`
