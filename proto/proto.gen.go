// quota-control v0.1.0 500d30e06e92b107a9df0b4ceeee775578eb450b
// --
...
func WebRPCSchemaHash() string {
	return "500d30e06e92b107a9df0b4ceeee775578eb450b"
}
...
type QuotaControl interface {
	...
	GetAccountUsage(ctx context.Context, projectID uint64, service *Service, cycle *Cycle, now time.Time) (*AccessUsage, error)
	GetAccessKeyUsage(ctx context.Context, accessKey string, service *Service, cycle *Cycle, now time.Time) (*AccessUsage, error)
...
func (c *quotaControlClient) GetAccountUsage(ctx context.Context, projectID uint64, service *Service, cycle *Cycle, now time.Time) (*AccessUsage, error) {
	in := struct {
		Arg0 uint64    `json:"projectID"`
		Arg1 *Service  `json:"service"`
		Arg2 *Cycle    `json:"cycle"`
...
func (c *quotaControlClient) GetAccessKeyUsage(ctx context.Context, accessKey string, service *Service, cycle *Cycle, now time.Time) (*AccessUsage, error) {
	in := struct {
		Arg0 string    `json:"accessKey"`
		Arg1 *Service  `json:"service"`
		Arg2 *Cycle    `json:"cycle"`
		Arg3 time.Time `json:"now"`
	}{accessKey, service, cycle, now}
	out := struct {
		Ret0 *AccessUsage `json:"usage"`
	}{}
