// quota-control v0.17.1 4933cab8ab9295055c64182cac0e128f2b63bf92
// --
// Code generated by webrpc-gen@v0.21.0 with golang@v0.15.0 generator. DO NOT EDIT.
//
// webrpc-gen -schema=proto.ridl -target=golang@v0.15.0 -pkg=proto -server -client -out=./proto.gen.go
package proto
...
func WebRPCSchemaHash() string {
	return "4933cab8ab9295055c64182cac0e128f2b63bf92"
}
...
// Schema errors
var (
	ErrTimeout           = WebRPCError{Code: 2001, Name: "Timeout", Message: "Request timed out", HTTPStatus: 408}
	ErrQuotaExceeded     = WebRPCError{Code: 2002, Name: "QuotaExceeded", Message: "Quota exceeded", HTTPStatus: 429}
	ErrRateLimit         = WebRPCError{Code: 2003, Name: "RateLimit", Message: "Rate limit exceeded", HTTPStatus: 429}
	ErrProjectNotFound   = WebRPCError{Code: 2004, Name: "ProjectNotFound", Message: "Project not found", HTTPStatus: 401}
	ErrAccessKeyNotFound = WebRPCError{Code: 2005, Name: "AccessKeyNotFound", Message: "Access key not found", HTTPStatus: 401}
	ErrAccessKeyMismatch = WebRPCError{Code: 2006, Name: "AccessKeyMismatch", Message: "Access key does not belong to the project", HTTPStatus: 403}
	ErrInvalidOrigin     = WebRPCError{Code: 2007, Name: "InvalidOrigin", Message: "Invalid origin", HTTPStatus: 403}
	ErrInvalidService    = WebRPCError{Code: 2008, Name: "InvalidService", Message: "Access key is not configured for this service", HTTPStatus: 403}
	ErrUnauthorizedUser  = WebRPCError{Code: 2009, Name: "UnauthorizedUser", Message: "Unauthorized user", HTTPStatus: 403}
	ErrNoDefaultKey      = WebRPCError{Code: 2011, Name: "NoDefaultKey", Message: "No default access key found", HTTPStatus: 403}
	ErrMaxAccessKeys     = WebRPCError{Code: 2012, Name: "MaxAccessKeys", Message: "Access keys limit reached", HTTPStatus: 403}
	ErrAtLeastOneKey     = WebRPCError{Code: 2013, Name: "AtLeastOneKey", Message: "There should be at least one active accessKey", HTTPStatus: 403}
)
