// quota-control v0.1.0 125387d13b2f1e4c757fb4b5fe2d4118304a8f93
// --
...
func WebRPCSchemaHash() string {
	return "125387d13b2f1e4c757fb4b5fe2d4118304a8f93"
}
...
type AccessLimit struct {
	...
	Config    map[Service]*ServiceLimit `json:"config"`
...
type AccessToken struct {
	...
	ComputeRateLimit int        `json:"computeRateLimit" db:"compute_rate_limit"`
	CreatedAt        *time.Time `json:"createdAt,omitempty" db:"created_at,omitempty"`
}
