// quota-control v0.1.0 022dd8ba46594c689212e9dcb0871db658434e8c
// --
...
func WebRPCSchemaHash() string {
	return "022dd8ba46594c689212e9dcb0871db658434e8c"
}
...
type QuotaControl interface {
	...
	ListAccessKeys(ctx context.Context, projectId uint64) ([]*AccessKey, error)
	...
	GetUsage(ctx context.Context, projectID uint64, service *Service, from *time.Time, to *time.Time) (*AccessUsage, error)
...
func (s *quotaControlServer) serveListAccessKeysJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.QuotaControl.ListAccessKeys(ctx, reqContent.Arg0)
	}()
	respContent := struct {
...
func (s *quotaControlServer) serveGetUsageJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.QuotaControl.GetUsage(ctx, reqContent.Arg0, reqContent.Arg1, reqContent.Arg2, reqContent.Arg3)
	}()
	respContent := struct {
...
func (c *quotaControlClient) ListAccessKeys(ctx context.Context, projectId uint64) ([]*AccessKey, error) {
	in := struct {
		Arg0 uint64 `json:"projectId"`
	}{projectId}
	out := struct {
...
func (c *quotaControlClient) GetUsage(ctx context.Context, projectID uint64, service *Service, from *time.Time, to *time.Time) (*AccessUsage, error) {
	in := struct {
		Arg0 uint64     `json:"projectID"`
		Arg1 *Service   `json:"service"`
		Arg2 *time.Time `json:"from"`
