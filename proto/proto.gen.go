// quota-control v0.1.0 479adfd28e17eeada00ccca3b4d80655698eccaa
// --
// Code generated by webrpc-gen@v0.18.6 with golang@v0.13.7 generator. DO NOT EDIT.
//
// webrpc-gen -schema=proto.ridl -target=golang@v0.13.7 -pkg=proto -server -client -out=./proto.gen.go
package proto
...
func WebRPCSchemaHash() string {
	return "479adfd28e17eeada00ccca3b4d80655698eccaa"
}
...
type QuotaControl interface {
	...
	PrepareUsage(ctx context.Context, projectID uint64, cycle *Cycle, now time.Time, key string) (bool, error)
...
func (c *quotaControlClient) PrepareUsage(ctx context.Context, projectID uint64, cycle *Cycle, now time.Time, key string) (bool, error) {
	in := struct {
		Arg0 uint64    `json:"projectID"`
		Arg1 *Cycle    `json:"cycle"`
		Arg2 time.Time `json:"now"`
		Arg3 string    `json:"key"`
	}{projectID, cycle, now, key}
	out := struct {
		Ret0 bool `json:"ok"`
	}{}
