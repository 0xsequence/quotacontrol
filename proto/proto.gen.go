// quota-control v0.1.0 2f29a61e790cc812b9aff350079a7beaca6a5ba2
// --
...
func WebRPCSchemaHash() string {
	return "2f29a61e790cc812b9aff350079a7beaca6a5ba2"
}
...
func (s *quotaControlServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/QuotaControl/GetProjectStatus":
		s.serveGetProjectStatus(ctx, w, r)
		return
	...
	case "/rpc/QuotaControl/ClearAccessQuotaCache":
		s.serveClearAccessQuotaCache(ctx, w, r)
		return
...
func (s *quotaControlServer) serveGetProjectStatus(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	case "application/json":
		s.serveGetProjectStatusJSON(ctx, w, r)
	default:
...
func (s *quotaControlServer) serveGetProjectStatusJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.QuotaControl.GetProjectStatus(ctx, reqContent.Arg0)
	}()
	respContent := struct {
...
func (s *quotaControlServer) serveGetAccessQuotaJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.QuotaControl.GetAccessQuota(ctx, reqContent.Arg0, reqContent.Arg1)
	}()
	respContent := struct {
...
func (s *quotaControlServer) serveClearAccessQuotaCache(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveClearAccessQuotaCacheJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *quotaControlServer) serveClearAccessQuotaCacheJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.QuotaControl.ClearAccessQuotaCache(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 bool `json:"ok"`
	}{ret0}
...
func (s *quotaControlServer) servePrepareUsageJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.QuotaControl.PrepareUsage(ctx, reqContent.Arg0, reqContent.Arg1, reqContent.Arg2, reqContent.Arg3)
	}()
	respContent := struct {
		Ret0 bool `json:"ok"`
	}{ret0}
