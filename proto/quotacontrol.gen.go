// quota-control v0.19.2 8c24b62aac70442bf97a940ac799d91ed7321149
// --
...
func WebRPCSchemaHash() string {
	return "8c24b62aac70442bf97a940ac799d91ed7321149"
}
...
type AccessKey struct {
	EcosystemID     uint64             `json:"ecosystemID" db:"-"`
...
type QuotaControl interface {
	...
	CreateAccessKey(ctx context.Context, projectId uint64, ecosystemId uint64, displayName string, requireOrigin bool, allowedOrigins []string, allowedServices []Service) (*AccessKey, error)
...
func (c *quotaControlClient) CreateAccessKey(ctx context.Context, projectId uint64, ecosystemId uint64, displayName string, requireOrigin bool, allowedOrigins []string, allowedServices []Service) (*AccessKey, error) {
	in := struct {
		Arg0 uint64    `json:"projectId"`
		Arg1 uint64    `json:"ecosystemId"`
		Arg2 string    `json:"displayName"`
		...
		Arg4 []string  `json:"allowedOrigins"`
		Arg5 []Service `json:"allowedServices"`
	}{projectId, ecosystemId, displayName, requireOrigin, allowedOrigins, allowedServices}
	out := struct {
		Ret0 *AccessKey `json:"accessKey"`
	}{}
