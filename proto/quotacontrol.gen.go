// quota-control v0.19.2 456846a7d3da3805e7f8b72dd6be6e074af4b97b
// --
...
func WebRPCSchemaHash() string {
	return "456846a7d3da3805e7f8b72dd6be6e074af4b97b"
}
...
type LimitSettings struct {
	// The maximum number of keys allowed for the project, zero means unlimited.
	MaxKeys int64 `json:"maxKeys"`
	// The default limit settings for a project.
	Base Limit `json:"base"`
	// The service-specific limits for the project.
	Service map[Service]Limit `json:"service"`
}

// Limit defines the limits for a project.
type Limit struct {
...
type LegacyLimit struct {
	...
	OverWarn     int64             `json:"overWarn"`
	OverMax      int64             `json:"overMax"`
	SvcRateLimit map[Service]int64 `json:"svcRateLimit,omitempty"`
}
