// quota-control v0.19.2 15e7769c932de06ab1c8757de38056644344f4a5
// --
...
func WebRPCSchemaHash() string {
	return "15e7769c932de06ab1c8757de38056644344f4a5"
}
...
type AccessKey struct {
	ParentProjectID uint64             `json:"parentProjectId" db:"-"`
...
type QuotaControl interface {
	...
	CreateAccessKey(ctx context.Context, projectId uint64, parentProjectId uint64, displayName string, requireOrigin bool, allowedOrigins []string, allowedServices []Service) (*AccessKey, error)
...
func (s *quotaControlServer) serveCreateAccessKeyJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	reqPayload := struct {
		Arg0 uint64    `json:"projectId"`
		Arg1 uint64    `json:"parentProjectId"`
		Arg2 string    `json:"displayName"`
		Arg3 bool      `json:"requireOrigin"`
		Arg4 []string  `json:"allowedOrigins"`
		Arg5 []Service `json:"allowedServices"`
	}{}
	if err := json.Unmarshal(reqBody, &reqPayload); err != nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadRequest.WithCausef("failed to unmarshal request data: %w", err))
		return
	...
	// Call service method implementation.
	ret0, err := s.QuotaControl.CreateAccessKey(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3, reqPayload.Arg4, reqPayload.Arg5)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (c *quotaControlClient) CreateAccessKey(ctx context.Context, projectId uint64, parentProjectId uint64, displayName string, requireOrigin bool, allowedOrigins []string, allowedServices []Service) (*AccessKey, error) {
	in := struct {
		Arg0 uint64    `json:"projectId"`
		Arg1 uint64    `json:"parentProjectId"`
		Arg2 string    `json:"displayName"`
		...
		Arg4 []string  `json:"allowedOrigins"`
		Arg5 []Service `json:"allowedServices"`
	}{projectId, parentProjectId, displayName, requireOrigin, allowedOrigins, allowedServices}
	out := struct {
		Ret0 *AccessKey `json:"accessKey"`
	}{}
