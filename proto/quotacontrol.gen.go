// quota-control v0-26.2.15+3168ad1 a224bd92c8a86397586f5dcefa0d7c8348aed3cc
// --
...
func WebRPCSchemaVersion() string {
	return "v0-26.2.15+3168ad1"
}

// Schema hash generated from your RIDL schema
func WebRPCSchemaHash() string {
	return "a224bd92c8a86397586f5dcefa0d7c8348aed3cc"
}
...
func (c *quotaControlClient) Ping(ctx context.Context) (bool, error) {
	out := struct {
		Ret0 bool `json:"ok"`
	}{}
...
func (c *quotaControlClient) Version(ctx context.Context) (string, error) {
	out := struct {
...
func (s *quotaControlService) serveVersionJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "Version")

	// Call service method implementation.
	ret0, err := s.QuotaControlServer.Version(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
const WebrpcHeaderValue = "webrpc@v0.31.1;gen-golang@v0.23.3;quota-control@v0-26.2.15+3168ad1"
