// quota-control v0.19.2 55381e43b3fa15adb2a72acfd45bb796bc05e9d6
// --
// Code generated by webrpc-gen@v0.22.0 with golang@v0.17.0 generator. DO NOT EDIT.
//
// webrpc-gen -schema=quotacontrol.ridl -target=golang@v0.17.0 -pkg=proto -server -client -out=./quotacontrol.gen.go
package proto
...
const WebrpcHeaderValue = "webrpc@v0.22.0;gen-golang@v0.17.0;quota-control@v0.19.2"
...
func WebRPCSchemaHash() string {
	return "55381e43b3fa15adb2a72acfd45bb796bc05e9d6"
}
...
var methods = map[string]method{
	...
	"/rpc/QuotaControl/UpdateDefaultAccessKey": {
		Name:        "UpdateDefaultAccessKey",
		Service:     "QuotaControl",
		Annotations: map[string]string{},
	},
	...
	"/rpc/QuotaControl/GetUsageProject": {
		Name:        "GetUsageProject",
		Service:     "QuotaControl",
		Annotations: map[string]string{},
	},
	"/rpc/QuotaControl/GetUsageAccessKey": {
		Name:        "GetUsageAccessKey",
		Service:     "QuotaControl",
		Annotations: map[string]string{},
	},
	"/rpc/QuotaControl/GetUsageAsync": {
		Name:        "GetUsageAsync",
		Service:     "QuotaControl",
		Annotations: map[string]string{},
	},
	...
	"/rpc/QuotaControl/StoreUsageProject": {
		Name:        "StoreUsageProject",
		Service:     "QuotaControl",
		Annotations: map[string]string{},
	},
	"/rpc/QuotaControl/StoreUsageAccessKey": {
		Name:        "StoreUsageAccessKey",
		Service:     "QuotaControl",
		Annotations: map[string]string{},
	},
...
type QuotaControl interface {
	...
	// deprecated: this is now GetUsageProject, and it will be removed in the future
	GetAccountUsage(ctx context.Context, projectID uint64, service *Service, from *time.Time, to *time.Time) (*AccessUsage, error)
	// deprecated: this is now GetUsageAccessKey, and it will be removed in the future
	GetAccessKeyUsage(ctx context.Context, accessKey string, service *Service, from *time.Time, to *time.Time) (*AccessUsage, error)
	// deprecated: this is now GetUsageAsync, and it will be removed in the future
	GetAsyncUsage(ctx context.Context, projectID uint64, service *Service, from *time.Time, to *time.Time) (*AccessUsage, error)
	GetUsageProject(ctx context.Context, projectID uint64, service *Service, from *time.Time, to *time.Time) (int64, error)
	GetUsageAccessKey(ctx context.Context, accessKey string, service *Service, from *time.Time, to *time.Time) (int64, error)
	GetUsageAsync(ctx context.Context, projectID uint64, service *Service, from *time.Time, to *time.Time) (int64, error)
	...
	// deprecated: this is now StoreUsageProject, and it will be removed in the future
	UpdateProjectUsage(ctx context.Context, service Service, now time.Time, usage map[uint64]*AccessUsage) (map[uint64]bool, error)
	// deprecated: this is now StoreUsageAccessKey, and it will be removed in the future
	UpdateKeyUsage(ctx context.Context, service Service, now time.Time, usage map[string]*AccessUsage) (map[string]bool, error)
	StoreUsageProject(ctx context.Context, service Service, now time.Time, usage map[uint64]int64) (map[uint64]bool, error)
	StoreUsageAccessKey(ctx context.Context, service Service, now time.Time, usage map[string]int64) (map[string]bool, error)
...
func (s *quotaControlServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/QuotaControl/GetUsageProject":
		handler = s.serveGetUsageProjectJSON
	case "/rpc/QuotaControl/GetUsageAccessKey":
		handler = s.serveGetUsageAccessKeyJSON
	case "/rpc/QuotaControl/GetUsageAsync":
		handler = s.serveGetUsageAsyncJSON
	...
	case "/rpc/QuotaControl/StoreUsageProject":
		handler = s.serveStoreUsageProjectJSON
	case "/rpc/QuotaControl/StoreUsageAccessKey":
		handler = s.serveStoreUsageAccessKeyJSON
...
func (s *quotaControlServer) serveCreateAccessKeyJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, err := s.QuotaControl.CreateAccessKey(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3, reqPayload.Arg4)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *quotaControlServer) serveUpdateAccessKeyJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, err := s.QuotaControl.UpdateAccessKey(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3, reqPayload.Arg4)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *quotaControlServer) serveGetUsageProjectJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetUsageProject")
	...
	// Call service method implementation.
	ret0, err := s.QuotaControl.GetUsageProject(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *quotaControlServer) serveGetUsageAccessKeyJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetUsageAccessKey")
	...
	// Call service method implementation.
	ret0, err := s.QuotaControl.GetUsageAccessKey(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *quotaControlServer) serveGetUsageAsyncJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetUsageAsync")
	...
	// Call service method implementation.
	ret0, err := s.QuotaControl.GetUsageAsync(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *quotaControlServer) serveStoreUsageProjectJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "StoreUsageProject")
	...
	// Call service method implementation.
	ret0, err := s.QuotaControl.StoreUsageProject(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *quotaControlServer) serveStoreUsageAccessKeyJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "StoreUsageAccessKey")
	...
	// Call service method implementation.
	ret0, err := s.QuotaControl.StoreUsageAccessKey(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func NewQuotaControlClient(addr string, client HTTPClient) QuotaControlClient {
	...
	urls := [26]string{
		...
		prefix + "GetUsageProject",
		prefix + "GetUsageAccessKey",
		prefix + "GetUsageAsync",
		prefix + "PrepareUsage",
		prefix + "ClearUsage",
		prefix + "NotifyEvent",
		prefix + "UpdateProjectUsage",
		prefix + "UpdateKeyUsage",
		prefix + "StoreUsageProject",
		prefix + "StoreUsageAccessKey",
...
func (c *quotaControlClient) GetUsageProject(ctx context.Context, projectID uint64, service *Service, from *time.Time, to *time.Time) (int64, error) {
	in := struct {
		Arg0 uint64     `json:"projectID"`
		Arg1 *Service   `json:"service"`
		Arg2 *time.Time `json:"from"`
...
func (c *quotaControlClient) GetUsageAccessKey(ctx context.Context, accessKey string, service *Service, from *time.Time, to *time.Time) (int64, error) {
	in := struct {
		Arg0 string     `json:"accessKey"`
		Arg1 *Service   `json:"service"`
		Arg2 *time.Time `json:"from"`
...
func (c *quotaControlClient) GetUsageAsync(ctx context.Context, projectID uint64, service *Service, from *time.Time, to *time.Time) (int64, error) {
	in := struct {
		Arg0 uint64     `json:"projectID"`
		Arg1 *Service   `json:"service"`
		Arg2 *time.Time `json:"from"`
...
func (c *quotaControlClient) StoreUsageProject(ctx context.Context, service Service, now time.Time, usage map[uint64]int64) (map[uint64]bool, error) {
	in := struct {
		Arg0 Service          `json:"service"`
		Arg1 time.Time        `json:"now"`
		Arg2 map[uint64]int64 `json:"usage"`
...
func (c *quotaControlClient) StoreUsageAccessKey(ctx context.Context, service Service, now time.Time, usage map[string]int64) (map[string]bool, error) {
	in := struct {
		Arg0 Service          `json:"service"`
		Arg1 time.Time        `json:"now"`
		Arg2 map[string]int64 `json:"usage"`
