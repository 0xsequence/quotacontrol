...
export const WebRPCSchemaHash = "cda14fd5b85f86d3a94f2016ea68f7a5a8891b62"
...
export interface ServiceLimit {
  ...
  computeMonthlyQuota: number
  computeMonthlyHardQuota: number
}
  ...
  getAccessLimit = (args: GetAccessLimitArgs, headers?: object, signal?: AbortSignal): Promise<GetAccessLimitReturn> => {
    return this.fetch(
      ...
      return buildResponse(res).then(_data => {
        return {
          config: <Array<ServiceLimit>>(_data.config),
        }
      })
    }, (error) => {
